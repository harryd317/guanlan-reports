...
- [x] **Step 1: Write failing path and read-only tests**
...
- [x] **Step 3: Implement constants, write guard, schema, and transactions**
...
- [x] **Step 1: Write failing calendar, field, idempotency, and 99% tests**
...
- [x] **Step 3: Implement canonical rows and batch audit**
...
- [x] **Step 4: Implement the coverage gate**
...
- [x] **Step 6: Run the real offline audit**
...
- [x] **Step 1: Write one failing test per frozen boundary**
...
- [x] **Step 4: Run Task 3 tests and verify GREEN**
...
- [x] **Step 1: Write a failing miniature-calendar integration test**
...
- [x] **Step 3: Implement day-by-day signal construction**
...
- [x] **Step 1: Write failing hand-calculated return tests**
...
- [x] **Step 4: Implement lifecycle and invalid-status handling**
...
- [x] **Step 5: Run Task 5 tests and verify GREEN**
...
- [x] **Step 1: Write failing statistic and decision tests**
...
- [x] **Step 2: Run Task 6 tests and verify RED**
...
- [x] **Step 3: Implement complete slice materialization**
...
- [x] **Step 4: Implement exact 16-cell qualification**
...
- [x] **Step 5: Run Task 6 tests and verify GREEN**
...
- [x] **Step 4: Implement the CLI gates**
...
- [x] **Step 6: Run the complete S7 unit suite**
...
- [x] **Step 1: Recheck source hashes and data coverage**
...
- [x] **Step 5: Audit scope and source immutability**
...
- [x] **Step 6: Commit final artifacts**
...
- [x] **Step 7: Sync and independently verify the mirror**
...
- [x] **Step 8: Stop on the branch and report evidence**
